  ...
  Tile(index) {
    return InkWell(
      onTap: () async {
        switch (index) {
          case 0:
            await launchUrl(Uri.parse('https://linktr.ee/astrotarot_app'));
            break;
          case 1:
            await launchUrl(
                Uri.parse('https://github.com/meliharik/SpotifyClone'));
            break;

          case 2:
            await launchUrl(Uri.parse('https://uludag.app'));

            break;

          case 3:
            await launchUrl(
                Uri.parse('https://github.com/meliharik/cinecasti'));
          ...
          case 5:
            await launchUrl(
                Uri.parse('https://github.com/meliharik/robot_arm'));
